...
#include "../LisansProjectQT/openglview.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_openGlView_t, stringdata0) + ofs \
...
const QMetaObject openGlView::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_openGlView.data,
...
void *openGlView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_openGlView.stringdata0))
